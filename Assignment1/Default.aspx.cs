...
public partial class _Default : System.Web.UI.Page
{
    ...
    private void  GetTotals()
    {
        ...
        if (goodAmount)
        {
            ...
            {
                if (TipPercentsRadioButtonList.SelectedItem.Text.Equals("10%"))  percent = .1; 
                if (TipPercentsRadioButtonList.SelectedItem.Text.Equals("15%"))  percent = .15;
                if (TipPercentsRadioButtonList.SelectedItem.Text.Equals("20%"))  percent = .20; 
